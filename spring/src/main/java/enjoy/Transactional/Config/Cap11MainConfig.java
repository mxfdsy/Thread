package enjoy.Transactional.Config;
...
@Configuration
@ComponentScan("enjoy.Transactional")
...
public class Cap11MainConfig {
	...
	public DataSource dataSource() throws PropertyVetoException{
		...
		dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/mxfdsy?characterEncoding=utf8&useSSL=true");
		return dataSource;
	}
